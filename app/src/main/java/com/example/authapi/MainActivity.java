...
public class MainActivity extends AppCompatActivity implements LoginFragment.ILogin, ProfileViewFragment.IProfileView, RegisterFragment.IRegister, UpdateProfileFragment.IUpdateProfile {
    ...
    public void logout(Return response){
        Request request = new Request.Builder()
